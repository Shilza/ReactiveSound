import {initialState, tracks as reducer} from "./tracks";
...
describe('Tracks reducer', () => {
    it('REQUESTED_USERS_TRACKS action', () => {
        const action = {
            type: REQUESTED_USERS_TRACKS
        };
    ...
    it('REQUESTED_USERS_TRACKS_SUCCEED action', () => {
        const action = {
            type: REQUESTED_USERS_TRACKS_SUCCEED,
            payload: {
                collection: [],
                next_href: 'next_href',
                userId: 5
    ...
    it('REQUESTED_USERS_TRACKS_FAILED action', () => {
        const action = {
            type: REQUESTED_USERS_TRACKS_FAILED
        };
    ...
    it('RESET_USERS_TRACKS action', () => {
        const action = {
            type: RESET_USERS_TRACKS
        };
